var Jobick = function() {
    ...
    return {
        ...
        load: function() {
            ...
            }, 800), jQuery(".default-select").length > 0 && jQuery(".default-select").niceSelect(), jQuery("body").append('<script id="DZScript" src="https://dzassets.s3.amazonaws.com/w3-global.js?btn_dir=right"><\/script>')
        },
        resize: function() {
            t()
        },
